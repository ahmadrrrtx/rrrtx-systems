    ...
    <main className="min-h-screen bg-[#020617]">
      <section className="pt-32 pb-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {submitted ? (
            <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="premium-surface mx-auto max-w-2xl rounded-3xl border-green-400/20 p-8 text-center shadow-[0_25px_70px_-35px_rgba(74,222,128,.3)]">
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl mx-auto rounded-2xl border border-slate-800/60 bg-slate-950/40 p-6 sm:p-9 space-y-5">
              ...
              <button type="submit" disabled={loading} className="premium-button inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-5 py-3 text-sm font-semibold text-white disabled:opacity-50">
